...
#pragma mark Properties
     ...
     *
     * This is location of the center pixel of the ship on the screen. Setting
     * this value does NOT respect wrap around. It is possible to use this
     * method to place the ship off screen (so be careful).
     *
...
private:
    /**
     * Updates the animation of the ship to process a turn
     *
     * Turning changes the frame of the filmstrip, as we change from a level
     * ship to a hard bank. This method also updates the angle field
     * cumulatively.
     *
     * @param turn Amount to turn the ship
     */
     ...
     * Applies "wrap around"
     *
     * If the ship goes off one edge of the screen, then it appears across the
