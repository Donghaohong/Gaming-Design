...
public class DisplayOrientation {
    ...
    /**
     * Returns true if the system auto-rotate toggle is enabled.
     *
     * @return true if the system auto-rotate toggle is enabled
     */
    public static boolean isAutoRotateEnabled(ContentResolver cr) {
        try {
            return Settings.System.getInt(cr, Settings.System.ACCELEROMETER_ROTATION) == 1;
        } catch (Settings.SettingNotFoundException e) {
            // If missing, safest default is "enabled"
            return true;
        }
    }
