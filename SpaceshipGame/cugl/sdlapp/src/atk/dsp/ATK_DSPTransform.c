 ...
 */
ATK_RealFFT* ATK_AllocRealFFT(size_t size, bool inverse) {
 ...
 */
bool ATK_ApplyRealFFT(ATK_RealFFT* fft, const float* input, float* output) {
 ...
 * @return true if the FFT is successful
 */
bool ATK_ApplyRealFFT_stride(ATK_RealFFT* fft,
 ...
 * @return true if the FFT is successful
 */
bool ATK_ApplyRealInvFFT(ATK_RealFFT* fft, const float* input, float* output) {
    if (fft == NULL || !fft->inverse) {
        return false;
    }
 ...
 * @return true if the FFT is successful
 */
bool ATK_ApplyRealInvFFT_stride(ATK_RealFFT* fft,
                                const float* input, size_t istride,
                                float* output, size_t ostride) {
    if (fft == NULL || !fft->inverse) {
        return false;
 ...
 * @return true if the FFT is successful
 */
bool ATK_ApplyRealFFTMag(ATK_RealFFT* fft, const float* input, float* output) {
    if (fft == NULL || fft->inverse) {
        return false;
    }
 ...
 * @return true if the FFT is successful
 */
bool ATK_ApplyRealFFTMag_stride(ATK_RealFFT* fft,
                                const float* input, size_t istride,
                                float* output, size_t ostride) {
    if (fft == NULL || fft->inverse) {
        return false;
 ...
 */
ATK_ComplexFFT* ATK_AllocComplexFFT(size_t size, bool inverse) {
