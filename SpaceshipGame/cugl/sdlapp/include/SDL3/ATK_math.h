 ...
 *
 * The distance is the Euclidean distance as if adata and bdata are len-size
 * vectors.
 *
 ...
 */
extern SDL_DECLSPEC double SDLCALL ATK_VecDistSq(const float* adata, const float* bdata, size_t len);
 ...
 */
extern SDL_DECLSPEC double SDLCALL ATK_VecDistSq_stride(const float* adata, size_t astride,
 ...
 */
extern SDL_DECLSPEC double SDLCALL ATK_VecDist(const float* adata, const float* bdata, size_t len);
 ...
 */
extern SDL_DECLSPEC double SDLCALL ATK_VecDist_stride(const float* adata, size_t astride,
                                                      const float* bdata, size_t bstride, size_t len);

/**
 * Returns the absolute difference of arrays adata and bdata
 *
 * The distance is the Manahattan distance as if adata and bdata are len-size
 * vectors. In other words, we compute the sum of the pointwise absolute value.
 *
 * @param adata The first array
 * @param bdata The second array
 * @param len   The number of elements to process
 ...
 */
extern SDL_DECLSPEC double SDLCALL ATK_VecDiff(const float* adata, const float* bdata, size_t len);
 ...
 */
extern SDL_DECLSPEC double SDLCALL ATK_VecDiff_stride(const float* adata, size_t astride,
                                                      const float* bdata, size_t bstride, size_t len);
 ...
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_VecHamm(const float* adata, const float* bdata,
 ...
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_VecHamm_stride(const float* adata, size_t astride,
 ...
 */
extern SDL_DECLSPEC float SDLCALL ATK_VecMax(float* data, size_t len);
 ...
 * @return the maximum value in the data buffer
 */
extern SDL_DECLSPEC float SDLCALL ATK_VecMax_stride(float* data, size_t stride, size_t len);

/**
 * Returns the index of the maximum value in the data buffer
 *
 * The maximum value is stored in the given pointer if it is not NULL. If the
 * buffer is empty, this returns Npos (-1).
 *
 * @param data      The data buffer
 * @param len       The number of elements to search
 ...
 * @return the maximum value in the data buffer
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_VecMaxIndex(float* data, size_t len, float* max);

/**
 * Returns the index of the maximum value in the data buffer
 *
 * The value is both searched and returned using the given stride. Elements
 * outside the given stride are ignored. For example if the stride is 2 and the
 * maximum value of the buffer is at (absolute) position 7, with a second
 * greatest value at 2, then this function will return 1 (e.g. absolute
 * position 2).
 *
 * The maximum value is stored in the given pointer if it is not NULL. If the
 * buffer is empty, this returns Npos (-1).
 ...
 * @return the maximum value in the data buffer
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_VecMaxIndex_stride(float* data, size_t stride, size_t len, float* max);

/**
 * Returns the maximum magnitude in the data buffer
 *
 * The maximum magnitude is the maximum absolute value of the buffer. If the
 * buffer is empty, this returns NaN.
 *
 * @param data      The data buffer
 * @param len       The number of elements to search
 *
 * @return the maximum value in the data buffer
 */
extern SDL_DECLSPEC float SDLCALL ATK_VecMaxMag(float* data, size_t len);

/**
 * Returns the maximum magnitude in the data buffer
 *
 * The magnitude is searched using the given stride. Elements outside of the
 * stride are ignored. If the buffer is empty, this returns NaN.
 *
 * @param data      The data buffer
 * @param stride    The data stride
 * @param len       The number of elements to search
 ...
 * @return the maximum value in the data buffer
 */
extern SDL_DECLSPEC float SDLCALL ATK_VecMaxMag_stride(float* data, size_t stride, size_t len);

/**
 * Returns the index of the maximum magnitude in the data buffer
 *
 * The maximum magnitude is stored in the given pointer if it is not NULL. If
 * the buffer is empty, this returns Npos (-1).
 *
 * @param data      The data buffer
 * @param len       The number of elements to search
 * @param max       Optional pointer to store the maximum
 ...
 * @return the maximum value in the data buffer
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_VecMaxMagIndex(float* data, size_t len, float* max);

/**
 * Returns the index of the maximum magnitude in the data buffer
 *
 * The magnitude is both searched and returned using the given stride. Elements
 * outside the given stride are ignored. For example if the stride is 2 and the
 * maximum value of the buffer is at (absolute) position 7, with a second
 * greatest value at 2, then this function will return 1 (e.g. absolute position
 * 2).
 *
 * The maximum magnitude is stored in the given pointer if it is not NULL. If
 * the buffer is empty, this function returns Npos (-1).
 *
 *
 * @param data      The data buffer
 * @param stride    The data stride
 ...
 * @return the maximum value in the data buffer
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_VecMaxMagIndex_stride(float* data, size_t stride, size_t len, float* max);
 ...
 */
extern SDL_DECLSPEC float SDLCALL ATK_VecMin(float* data, size_t len);
 ...
 * @return the minimum value in the data buffer
 */
extern SDL_DECLSPEC float SDLCALL ATK_VecMin_stride(float* data, size_t stride, size_t len);

/**
 * Returns the index of the minimum value in the data buffer
 *
 * The minimum value is stored in the given pointer if it is not NULL. If the
 * buffer is empty, this returns Npos (-1).
 *
 * @param data      The data buffer
 * @param len       The number of elements to search
 ...
 * @return the minimum value in the data buffer
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_VecMinIndex(float* data, size_t len, float* min);
 ...
 * The value is both searched and returned using the given stride. Elements
 * outside the given stride are ignored. For example if the stride is 2 and the
 * minimum value of the buffer is at (absolute) position 7, with a second least
 * value at 2, then this function will return 1 (e.g. absolute position 2).
 *
 * The minimum value is stored in the given pointer if it is not NULL. If the
 * buffer is empty, this returns Npos (-1).
 *
 ...
 * @return the minimum value in the data buffer
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_VecMinIndex_stride(float* data, size_t stride, size_t len, float* min);

/**
 * Returns the minimum magnitude in the data buffer
 *
 * The minimum magnitude is the maximum absolute value of the buffer. If the
 * buffer is empty, this returns NaN.
 *
 * @param data      The data buffer
 * @param len       The number of elements to search
 ...
 * @return the minimum value in the data buffer
 */
extern SDL_DECLSPEC float SDLCALL ATK_VecMinMag(float* data, size_t len);
 ...
 * @return the minimum value in the data buffer
 */
extern SDL_DECLSPEC float SDLCALL ATK_VecMinMag_stride(float* data, size_t stride, size_t len);

/**
 * Returns the index of the minimum magnitude in the data buffer
 *
 * The minimum magnitude is stored in the given pointer if it is not NULL. If
 * the buffer is empty, this returns Npos (-1).
 *
 * @param data      The data buffer
 * @param len       The number of elements to search
 ...
 * @return the minimum value in the data buffer
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_VecMinMagIndex(float* data, size_t len, float* min);
 ...
 * @return the minimum value in the data buffer
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_VecMinMagIndex_stride(float* data, size_t stride, size_t len, float* min);
 ...
 * @param len       The number of elements to copy
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecCopy_stride(const float* src, size_t sstride,
 ...
 * @param len       The number of elements to copy
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecCopy_dstride(const float* src,
 ...
 * @param len       The number of elements to copy
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecCopy_sstride(const float* src, size_t sstride,
                                                     float* dst, size_t len);

/**
 * Swaps the first len elements of adata and bdata
 *
 * This function DOES NOT check whether adata and bdata overlap, and it is
 * generally unsafe to use the function in that case (except when they are
 * identical).
 *
 ...
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecSwap(float* adata, float* bdata, size_t len);
 ...
 * @param len       The number of elements to swap
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecSwap_stride(float* adata, size_t astride,
 ...
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecReverse(const float* src, float* dst, size_t len);
 ...
 * @param len       The number of elements to reverse
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecReverse_stride(const float* src, size_t sstride,
                                                       float* dst, size_t dstride, size_t len);
 ...
 * @param len   The number of elements to process
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecRoll(const float* src, Sint64 amt, float* dst, size_t len);
 ...
 * @param len       The number of elements to process
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecRoll_stride(const float* src, size_t sstride, Sint64 amt,
                                                    float* dst, size_t dstride, size_t len);
 ...
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecClear(float* data, size_t len);
 ...
 * @param len       the buffer length
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecClear_stride(float* data, size_t stride, size_t len);
 ...
 * @param len       the buffer length
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecFill(float* data, float value, size_t len);
 ...
 * @param len       the buffer length
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecFill_stride(float* data, size_t stride, float value, size_t len);


/**
 * Fills the given buffer with a linear ramp from start to stop.
 *
 * The first element of data will be start, while the last will be stop. All
 * elements in-between will be equidistant.
 *
 * @param data      the buffer to fill
 ...
 * @param len       the buffer length
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecRamp(float* data, float start, float stop, size_t len);

/**
 * Fills the given buffer with a linear ramp from start to stop.
 *
 * The first element of data will be start, while the last will be stop. All
 * elements in-between (with respect to the given stride) will be equidistant.
 *
 * @param data      the buffer to fill
 * @param stride    the buffer stride
 * @param start     the initial value
 ...
 * @param len       the buffer length
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecRamp_stride(float* data, size_t stride, float start, float stop, size_t len);
 ...
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecAbs(const float* input, float* output, size_t len);
 ...
 * @param len       The number of elements in the buffers
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecAbs_stride(const float* input, size_t istride,
 ...
 * @param len       The number of elements in the buffers
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecAbsNeg(const float* input, float* output, size_t len);

/**
 * Outputs the negative absolute value of the input buffer.
 *
 * It is safe for output to be the same as the input buffer, provided that the
 * strides match up. However, this function does not check that this is the
 * case.
 *
 * @param input     The input buffer
 * @param istride   The data stride of the input buffer
 ...
 * @param len       The number of elements in the buffers
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecAbsNeg_stride(const float* input, size_t istride,
                                                      float* output, size_t ostride, size_t len);
 ...
 * @param len       The number of elements in the buffers
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecNeg(const float* input, float* output, size_t len);
 ...
 * @param len       The number of elements in the buffers
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecNeg_stride(const float* input, size_t istride,
                                                   float* output, size_t ostride, size_t len);
 ...
 * @param len       The number of elements in the buffers
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecInv(const float* input, float* output, size_t len);
 ...
 * @param len       The number of elements in the buffers
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecInv_stride(const float* input, size_t istride,
                                                   float* output, size_t ostride, size_t len);
 ...
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecAdd(const float* input1, const float* input2,
 ...
 * @param len       The number of elements to add
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecAdd_stride(const float* input1, size_t istride1,
 ...
 * @param len       The number of elements to add
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecSub(const float* input1, const float* input2,
                                            float* output, size_t len);
 ...
 * @param len       The number of elements to add
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecSub_stride(const float* input1, size_t istride1,
                                                   const float* input2, size_t istride2,
                                                   float* output, size_t ostride, size_t len);
 ...
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecMult(const float* input1, const float* input2,
                                             float* output, size_t len);
 ...
 * @param len       The number of elements to multiply
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecMult_stride(const float* input1, size_t istride1,
                                                    const float* input2, size_t istride2,
                                                    float* output, size_t ostride, size_t len);
 ...
 * @param len       The number of elements to multiply
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecDiv(const float* input1, const float* input2,
                                            float* output, size_t len);
 ...
 * @param len       The number of elements to multiply
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecDiv_stride(const float* input1, size_t istride1,
                                                   const float* input2, size_t istride2,
                                                   float* output, size_t ostride, size_t len);
 ...
 * @param len       The number of elements to multiply
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecScale(const float* input, float scalar, float* output, size_t len);
 ...
 * @param len       The number of elements to multiply
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecScale_stride(const float* input, size_t istride, float scalar,
                                                     float* output, size_t ostride, size_t len);
 ...
 * @param len       The number of elements to process
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecScaleAdd(const float* input1, const float* input2, float scalar,
                                                 float* output, size_t len);
 ...
 * @param len       The number of elements to add
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecScaleAdd_stride(const float* input1, size_t istride1,
 ...
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecClip(const float* input, float min, float max,
                                             float* output, size_t len);
 ...
 * @param len       The number of elements to clip
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecClip_stride(const float* input, size_t istride,
                                                    float min, float max,
                                                    float* output, size_t ostride, size_t len);
 ...
 * @param len       The number of elements to clip
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecClipZero(const float* input, float min, float max,
                                                 float* output, size_t len);
 ...
 * @param len       The number of elements to clip
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecClipZero_stride(const float* input, size_t istride,
                                                        float min, float max,
                                                        float* output, size_t ostride, size_t len);
 ...
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecClipCount(const float* input, float min, float max,
                                                  float* output, size_t len,
 ...
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecClipCount_stride(const float* input, size_t istride,
                                                         float min, float max,
                                                         float* output, size_t ostride, size_t len,
                                                         size_t* mincnt, size_t* maxcnt);
/**
 ...
 *
 * The clip is a soft knee. Values in the range [-knee, knee] are not affected.
 * Values outside this range are asymptotically clipped to the range
 * [-bound,bound] with the formula
 *
 ...
 * @param len       The number of elements to clip
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecClipKnee(const float* input, float bound, float knee,
                                                 float* output, size_t len);
 ...
 * @param len       The number of elements to clip
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecClipKnee_stride(const float* input, size_t istride,
 ...
 * @param len       The number of elements to clip
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecExclude(const float* input,
                                                float min, float max,
                                                float* output, size_t len);
 ...
 * @param len       The number of elements to clip
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecExclude_stride(const float* input, size_t istride,
                                                       float min, float max,
                                                       float* output, size_t ostride, size_t len);
 ...
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_VecThreshold(const float* input, float min,
                                                    float* output, size_t len);
 ...
 * @return the number of elements clipped
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_VecThreshold_stride(const float* input, size_t istride, float min,
                                                           float* output, size_t ostride, size_t len);
 ...
 * @return the number of elements clipped
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_VecThresholdInvert(const float* input, float min,
                                                          float* output, size_t len);
 ...
 * @return the number of elements clipped
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_VecThresholdInvert_stride(const float* input, size_t istride, float min,
                                                                 float* output, size_t ostride, size_t len);
 ...
 * @param len       The number of elements to clip
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecThresholdSign(const float* input, float min, float scalar,
                                                      float* output, size_t len);

/**
 * Clips the input buffer to a signed constant relative to a threshold.
 *
 * Values greater than or equal to min are assigned scalar, while all others
 * are assigned -scalar.
 *
 * It is safe for output to be the same as the input buffer, provided that the
 * strides match up. However, this function does not check that this is the
 ...
 * @param len       The number of elements to clip
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecThresholdSign_stride(const float* input, size_t istride,
 ...
 * @return the number of elements clipped
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_VecLimit(const float* input, float max,
                                                float* output, size_t len);
 ...
 * @return the number of elements clipped
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_VecLimit_stride(const float* input, size_t istride, float max,
                                                       float* output, size_t ostride, size_t len);
 ...
 * @return the number of elements clipped
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_VecLimitInvert(const float* input, float max,
                                                      float* output, size_t len);
 ...
 * @return the number of elements clipped
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_VecLimitInvert_stride(const float* input, size_t istride, float max,
                                                             float* output, size_t ostride, size_t len);

/**
 * Clips the input buffer to a signed constant relative to a limit.
 *
 * Values less than or equal to max are assigned scalar, while all others are
 * assigned -scalar.
 *
 * It is safe for output to be the same as the input buffer.
 *
 ...
 * @param len       The number of elements to clip
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecLimitSign(const float* input, float max, float scalar,
                                                  float* output, size_t len);
 ...
 * @param len       The number of elements to clip
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecLimitSign_stride(const float* input, size_t istride,
 ...
 */
extern SDL_DECLSPEC float SDLCALL ATK_VecSum(const float* input, size_t len);
 ...
 */
extern SDL_DECLSPEC float SDLCALL ATK_VecSum_stride(const float* input, size_t stride, size_t len);
 ...
 */
extern SDL_DECLSPEC float SDLCALL ATK_VecSumMag(const float* input, size_t len);
 ...
 */
extern SDL_DECLSPEC float SDLCALL ATK_VecSumMag_stride(const float* input, size_t stride, size_t len);
 ...
 */
extern SDL_DECLSPEC float SDLCALL ATK_VecSumSq(const float* input, size_t len);
 ...
 */
extern SDL_DECLSPEC float SDLCALL ATK_VecSumSq_stride(const float* input, size_t stride, size_t len);
 ...
 */
extern SDL_DECLSPEC float SDLCALL ATK_VecAverage(const float* input, size_t len);
 ...
 */
extern SDL_DECLSPEC float SDLCALL ATK_VecAverage_stride(const float* input, size_t stride, size_t len);
 ...
 */
extern SDL_DECLSPEC float SDLCALL ATK_VecMeanSq(const float* input, size_t len);
 ...
 */
extern SDL_DECLSPEC float SDLCALL ATK_VecMeanSq_stride(const float* input, size_t stride, size_t len);
 ...
 * @return the standard deviation of input.
 */
extern SDL_DECLSPEC float SDLCALL ATK_VecStdDev(const float* input, size_t len);
 ...
 * @return the standard deviation of input, accounting for stride.
 */
extern SDL_DECLSPEC float SDLCALL ATK_VecStdDev_stride(const float* input, size_t stride, size_t len);
 ...
 *
 * The elements of the output vector will be (1-factor)*a+factor*b where a is
 * from input1 and b is from input2.
 *
 * It is safe for output to be the same as one of the two input buffers.
 *
 * @param input1    The first input buffer
 ...
 * @param len       The number of elements in the buffers
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecInterp(const float* input1, const float* input2,
                                               float factor, float* output, size_t len);

/**
 * Computes the linear interpolation of input1 and input2
 *
 * The elements of the output vector will be (1-t)*a+t*b where a is from input1
 * and b is from input2.
 *
 * It is safe for output to be the same as the input buffer, provided that the
 * strides match up. However, this function does not check that this is the
 * case.
 ...
 * @param len       The number of elements in the buffers
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecInterp_stride(const float* input1, size_t istride1,
 ...
 *
 * For each element of b of factors, the integer portion t = trunc(b) must
 * refer to a position in input. The output value is the interpolation
 *
 *     input[t]*(1-b+t)+input[t+1]*(b-t)
 *
 * Values at the boundaries will be zero clamped.
 *
 * It is generally NOT safe for the output buffer to be the same as the input
 * buffer
 *
 * @param input     The input buffer
 ...
 * @param len       The number of elements in the buffers
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecPairInterp(const float* input, const float* factors,
                                                   float* output, size_t len);
 ...
 *
 * For each element of b of factors, the integer portion t = trunc(b) must
 * refer to a position in input relative to the given stride. The output value
 ...
 * @param len       The number of elements in the buffers
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecPairInterp_stride(const float* input, size_t istride, const float* factors,
                                                          float* output, size_t ostride, size_t len);
 ...
 * @param len       The number of elements to multiply
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecSlide(const float* input, float start, float end,
                                              float* output, size_t len);
 ...
 * @param len       The number of elements to multiply
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecSlide_stride(const float* input, size_t istride,
 ...
 * @param len       The number of elements to process
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecSlideAdd(const float* input1, const float* input2,
 ...
 * @param len       The number of elements to process
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecSlideAdd_stride(const float* input1, size_t istride1,
                                                        const float* input2, size_t istride2,
                                                        float start, float end,
                                                        float* output, size_t ostride, size_t len);
 ...
 *
 * The value zero is considered the reference value for zero decibels (as
 * decibels are unitless by themselves). As power and amplitude produce slightly
 ...
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecPowAmpToDecib(const float* input, float zero, bool power,
                                                      float* output, size_t len);
 ...
 * @param len       The number of elements to convert
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecPowAmpToDecib_stride(const float* input, size_t istride,
                                                             float zero, bool power,
                                                             float* output, size_t ostride, size_t len);
 ...
 * @param len       The number of elements to convert
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecDecibToPowAmp(const float* input, float zero, bool power,
                                                      float* output, size_t len);

/**
 * Converts values from decibels to amplitude/power.
 *
 * The value zero is considered the power for zero decibels (as decibels are
 * unitless by themselves). As power and amplitude produce slightly different
 * results, this function has a flag to specify the one desired.
 *
 * It is safe for output to be the same as the input buffer, provided that the
 * strides match up. However, this function does not check that this is the
 * case.
 ...
 * @param len       The number of elements to convert
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecDecibToPowAmp_stride(const float* input, size_t istride,
                                                             float zero, bool power,
                                                             float* output, size_t ostride, size_t len);
 ...
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_VecZeroCross(const float* input, size_t max,
 ...
 * @return the number of zero-crossings found
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_VecZeroCross_stride(const float* input,size_t stride,
 ...
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecInterleave(const float** input, size_t stride,
                                                   float* output, size_t len);
 ...
 * @param len       The number of elements in the streams
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecDeinterleave(const float* input, size_t stride,
                                                     float** output, size_t len);
 ...
 */
extern SDL_DECLSPEC void SDLCALL ATK_VecFlatten(const float* input, size_t stride,
                                                float* output, size_t len);
 ...
 * (interleaved) float pairs. So all even positions are reals and all odd
 * positions are imaginary. The len is the number of complex numbers in the
 * buffer, and is hence half the size of the buffer.
 *
 ...
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexNorm(const float* input, float* output, size_t len);
 ...
 * @param len       The number of elements in the buffers
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexNorm_stride(const float* input, size_t istride,
                                                    float* output, size_t ostride, size_t len);
 ...
 * @param len       The number of complex numbers in the buffer
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexNormSq(const float* input, float* output, size_t len);
 ...
 * @param len       The number of elements in the buffers
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexNormSq_stride(const float* input, size_t istride,
                                                          float* output, size_t ostride, size_t len);
 ...
 * @param len       The number of complex numbers in the buffer
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexConj(const float* input, float* output, size_t len);
 ...
 * @param len       The number of elements in the buffers
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexConj_stride(const float* input, size_t istride,
                                                        float* output, size_t ostride, size_t len);
 ...
 * @param len       The number of complex numbers in the buffer
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexAngle(const float* input, float* output, size_t len);
 ...
 * @param len       The number of elements in the buffers
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexAngle_stride(const float* input, size_t istride,
                                                         float* output, size_t ostride, size_t len);
 ...
 * @param len       The number of complex numbers in the buffer
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexRot(const float* input, float angle, float* output, size_t len);
 ...
 * @param len       The number of elements in the buffers
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexRot_stride(const float* input, size_t istride, float angle,
                                                       float* output, size_t ostride, size_t len);
 ...
 * @param len       The number of elements in the buffers
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexNeg_stride(const float* input, size_t istride,
                                                       float* output, size_t ostride, size_t len);
 ...
 * @param len       The number of elements in the buffers
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexInv(const float* input, float* output, size_t len);
 ...
 * @param len       The number of elements in the buffers
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexInv_stride(const float* input, size_t istride,
                                                       float* output, size_t ostride, size_t len);
 ...
 * @param len       The number of elements to add
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexAdd_stride(const float* input1, size_t istride1,
                                                       const float* input2, size_t istride2,
                                                       float* output, size_t ostride, size_t len);
 ...
 * @param len       The number of elements to add
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexSub_stride(const float* input1, size_t istride1,
                                                       const float* input2, size_t istride2,
                                                       float* output, size_t ostride, size_t len);
 ...
 * @param len       The number of elements to multiply
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexMult(const float* input1, const float* input2,
                                                 float* output, size_t len);
 ...
 * @param len       The number of elements to multiply
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexMult_stride(const float* input1, size_t istride1,
                                                        const float* input2, size_t istride2,
                                                        float* output, size_t ostride, size_t len);
 ...
 * @param len       The number of elements to multiply
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexScale(const float* input, float real, float imag,
                                                  float* output, size_t len);
 ...
 * @param len       The number of elements to multiply
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexScale_stride(const float* input, size_t istride,
 ...
 * @param len       The number of elements to multiply
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexDiv(const float* input1, const float* input2,
                                                float* output, size_t len);
 ...
 * @param len       The number of elements to multiply
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexDiv_stride(const float* input1, size_t istride1,
                                                       const float* input2, size_t istride2,
                                                       float* output, size_t ostride, size_t len);
 ...
 * @param len       The number of elements to process
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexScaleAdd(const float* input1, const float* input2,
                                                     float real, float imag,
                                                     float* output, size_t len);
 ...
 * @param len       The number of elements to add
 */
extern SDL_DECLSPEC void SDLCALL ATK_ComplexScaleAdd_stride(const float* input1, size_t istride1,
                                                            const float* input2, size_t istride2,
                                                            float real, float imag,
                                                            float* output, size_t ostride, size_t len);
 ...
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_PolyStandardize(const float* input, size_t degree, float* output);
 ...
 * @return the degree of the output polynomial
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_PolyNormalize(const float* input, size_t degree, float* output);
 ...
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_PolyAdd(const float* poly1, size_t degree1,
 ...
 * @param output    The output polynomial
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_PolySub(const float* poly1, size_t degree1,
                                               const float* poly2, size_t degree2,
                                               float* output);
 ...
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_PolyScale(const float* poly, size_t degree,
 ...
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_PolyScaleAdd(const float* poly1, size_t degree1, float scalar,
 ...
 * @param output    The output polynomial
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_PolyMult(const float* poly1, size_t degree1,
                                                const float* poly2, size_t degree2,
                                                float* output);
 ...
 * @param output    The output polynomial
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_PolyIterativeMult(const float* poly1, size_t degree1,
                                                         const float* poly2, size_t degree2,
                                                         float* output);
 ...
 * @param output    The output polynomial
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_PolyRecursiveMult(const float* poly1, size_t degree1,
                                                         const float* poly2, size_t degree2,
                                                         float* output);
 ...
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_PolySyntheticDiv(const float* poly1, size_t degree1,
                                                        const float* poly2, size_t degree2,
                                                        float* output);
 ...
 * too large or the zero polynomial, this function will return 0 for the zero
 ...
 * @return the degree of the quotient polynomial
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_PolyDiv(const float* poly1, size_t degree1,
                                               const float* poly2, size_t degree2,
                                               float* output);
 ...
 */
extern SDL_DECLSPEC size_t SDLCALL ATK_PolyRem(const float* poly1, size_t degree1,
                                               const float* poly2, size_t degree2,
                                               float* output);
 ...
 */
extern SDL_DECLSPEC float SDLCALL ATK_PolyEvaluate(const float* poly, size_t degree, float value);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL ATK_PolyRoots(const float* poly, size_t degree, float* roots,
 ...
 * @return true if Bairstow's method completes successfully
 */
extern SDL_DECLSPEC bool SDLCALL ATK_PolyRealRoots(const float* poly, size_t degree, float* roots,
                                                   const ATK_BairstowPrefs* prefs);
 ...
 * @param output    The output polynomial
 */
extern SDL_DECLSPEC void SDLCALL ATK_PolyDerive(const float* input, size_t degree, float* output);
 ...
 * @param output    The output polynomial
 */
extern SDL_DECLSPEC void SDLCALL ATK_PolyIntegrate(const float* input, size_t degree, float* output);
