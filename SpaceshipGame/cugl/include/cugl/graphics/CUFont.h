...
protected:
     ...
     *
     * A font atlas is a collection of pre-rendered glyphs, together with a
     * directory of the bounds for each glyph. This directory information makes
     * it very easy to quickly construct a textured quad mesh for a series of
     * glyphs.
     *
     * An font may have more than one atlas, particulary if the font size is
     * large and there are a large number of supported glyphs. In that case,
     * the atlases typically support a disjoint set of glyphs. However, we do
     * not enforce this.
     */
    class Atlas {
    private:
         ...
         *
         * This method computes both the size of the atlas and the placement of
         * the individual glyphs. This method will consume glyphs from the
         * provided glyphset as it assigns them a position. So if it successfully
    ...
    public:
        /** The image (may be null if not materialized) */
         ...
         *
         * NEVER USE A CONSTRUCTOR WITH NEW. If you want to allocate an object
...
#pragma mark Constructors
     ...
     * {@link Application#getAssetDirectory}. If you wish to load a font from
...
#pragma mark Attributes
    ...
    /**
     * Returns the sampler for this font
     *
     * This sampler will be applied to any glyph run generated by this font.
     * Changes to this sampler will be reflected in all such glyph runs.
     *
     * @return the sampler for this font
     */
...
#pragma mark Glyph Generation
     ...
     *
     * The keys for the glyph runs are the {@link Texture#id} values for the
     * appropriate atlas texture. This, combined with the method
     ...
     */
    std::unordered_map<size_t, std::shared_ptr<GlyphRun>> getGlyphs(const std::string text, const Vec2& origin);
     ...
     * @return a set of glyph runs to render the given string
     */
    std::unordered_map<size_t, std::shared_ptr<GlyphRun>> getGlyphs(const char* substr, const char* end,
                                                                    const Vec2& origin);
     ...
     */
    size_t getGlyphs(std::unordered_map<size_t, std::shared_ptr<GlyphRun>>& runs,
