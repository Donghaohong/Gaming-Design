 ...
 * with a {@link GraphicsShader}. With that said, the vertices are all instances
 * of {@link SpriteVertex}, and thus this class can be used with the default
...
private:
    ...
    std::shared_ptr<VertexBuffer> _vbuffer;
    /** The internal index buffer */
    std::shared_ptr<IndexBuffer> _ibuffer;
...
#pragma mark Rendering
     ...
     * {@link GraphicsShader}, preferably one compatible with {@link SpriteBatch}.
     * To guarantee this, use {@link #declareAttributes} before compiling the
     * shader.
     *
     * @return the vertex buffer for this mesh.
     */
    const std::shared_ptr<VertexBuffer> getVertexBuffer() const { return _vbuffer; }
     ...
     * @return the vertex buffer for this mesh.
     */
    const std::shared_ptr<IndexBuffer> getIndexBuffer() const { return _ibuffer; }
     ...
     * shader separately as resources.
     *
     * To work properly, this shader must support attributes with the given
     * group that match this mesh. Use {@link #declareAttributes} before
     * compiling the shader to guarantee this.
     *
