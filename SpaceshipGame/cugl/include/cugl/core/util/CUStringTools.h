...
#pragma mark ARRAY TO STRING FUNCTIONS
     ...
     */
    std::string to_string(Uint8* array, size_t length);
     ...
     */
    std::string to_string(Sint16* array, size_t length);
     ...
     */
    std::string to_string(Uint16* array, size_t length);
     ...
     */
    std::string to_string(Sint32* array, size_t length);
     ...
     */
    std::string to_string(Uint32* array, size_t length);
     ...
     */
    std::string to_string(Sint64* array, size_t length);
     ...
     */
    std::string to_string(Uint64* array, size_t length);
     ...
     * (the number of digits to display after the decimal point). If precision
     * is negative, then maximum precision will be used.
     *
     * @param array     the array to convert
     * @param length    the array length
     * @param precision the number of digits to display after the decimal
     ...
     */
    std::string to_string(float* array, size_t length, int precision=-1);
     ...
     */
    std::string to_string(double* array, size_t length, int precision=-1);
