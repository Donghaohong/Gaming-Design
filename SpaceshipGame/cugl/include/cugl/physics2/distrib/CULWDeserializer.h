...
public:
    ...
    float readFloat() {
        ...
        // We need to copy for alignment issues
        float r;
        std::memcpy(&r,_data.data()+_pos,sizeof(float));
        _pos += sizeof(float);
        return marshall(r);
    }
    ...
    Sint32 readSint32() {
        ...
        // We need to copy for alignment issues
        Sint32 r;
        std::memcpy(&r,_data.data()+_pos,sizeof(Sint32));
        _pos += sizeof(Sint32);
        return marshall(r);
    }
    ...
    Uint16 readUint16() {
        ...
        // We need to copy for alignment issues
        Uint16 r;
        std::memcpy(&r,_data.data()+_pos,sizeof(Uint16));
        _pos += sizeof(Uint16);
        return marshall(r);
    }
    ...
    Uint32 readUint32() {
        ...
        // We need to copy for alignment issues
        Uint32 r;
        std::memcpy(&r,_data.data()+_pos,sizeof(Uint32));
        _pos += sizeof(Uint32);
        return marshall(r);
    }
    ...
    Uint64 readUint64() {
        ...
        // We need to copy for alignment issues
        Uint64 r;
        std::memcpy(&r,_data.data()+_pos,sizeof(Uint64));
        _pos += sizeof(Uint64);
        return marshall(r);
    }
