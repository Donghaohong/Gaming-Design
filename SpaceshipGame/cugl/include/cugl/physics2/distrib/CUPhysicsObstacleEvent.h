...
//
#ifndef __CU_PHYSICS_OBSTACLE_EVENT_H__
#define __CU_PHYSICS_OBSTACLE_EVENT_H__
 ...
 */
class PhysicsObstacleEvent : public NetEvent {
public:
...
#pragma Event Allocators
    ...
    std::shared_ptr<NetEvent> newEvent() override {
        return std::make_shared<PhysicsObstacleEvent>();
    }
     ...
     */
    static std::shared_ptr<PhysicsObstacleEvent> allocCreation(Uint32 factoryId,
                                                               Uint64 obsId,
                                                               std::shared_ptr<std::vector<std::byte>> packedParam) {
        auto e = std::make_shared<PhysicsObstacleEvent>();
     ...
     */
    static std::shared_ptr<PhysicsObstacleEvent> allocDeletion(Uint64 obsId) {
        auto e = std::make_shared<PhysicsObstacleEvent>();
     ...
     */
    static std::shared_ptr<PhysicsObstacleEvent> allocPos(Uint64 obsId, Vec2 pos) {
        auto e = std::make_shared<PhysicsObstacleEvent>();
        e->initPos(obsId, pos);
        return e;
    }
     ...
     */
    static std::shared_ptr<PhysicsObstacleEvent> allocVel(Uint64 obsId, Vec2 vel) {
        auto e = std::make_shared<PhysicsObstacleEvent>();
        e->initVel(obsId, vel);
        return e;
    }
     ...
     */
    static std::shared_ptr<PhysicsObstacleEvent> allocAngle(Uint64 obsId, float angle) {
        auto e = std::make_shared<PhysicsObstacleEvent>();
     ...
     */
    static std::shared_ptr<PhysicsObstacleEvent> allocAngularVel(Uint64 obsId,
                                                                 float angularVel) {
        auto e = std::make_shared<PhysicsObstacleEvent>();
     ...
     */
    static std::shared_ptr<PhysicsObstacleEvent> allocBodyType(Uint64 obsId,
                                                               b2BodyType bodyType) {
        auto e = std::make_shared<PhysicsObstacleEvent>();
     ...
     */
    static std::shared_ptr<PhysicsObstacleEvent> allocBoolConsts(Uint64 obsId,
     ...
     */
    static std::shared_ptr<PhysicsObstacleEvent> allocFloatConsts(Uint64 obsId,
     ...
     */
    static std::shared_ptr<PhysicsObstacleEvent> allocOwnerAcquire(Uint64 obsId,
                                                                   Uint64 duration) {
        auto e = std::make_shared<PhysicsObstacleEvent>();
     ...
     */
    static std::shared_ptr<PhysicsObstacleEvent> allocOwnerRelease(Uint64 obsId) {
        auto e = std::make_shared<PhysicsObstacleEvent>();
