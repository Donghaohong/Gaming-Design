...
public:
     ...
     * anchor positions are relative to the Node bounding box. There are also,
     * several "fill" anchors, which stretch the node to fill the available
     * space.
     *
     * Finally, there are specific Figma-style anchors which are used to
     * mirror the behavior of a Figma project.
     */
...
#pragma mark Layout Helpers
     ...
     */
    static void placeNode(SceneNode* node, Anchor anchor, const Rect& bounds,
                          const Vec2& offset);
