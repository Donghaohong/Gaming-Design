...
public:
     ...
     * of the display. The scene will not have a sprite batch. This must be
     * assigned separately with {@link #setSpriteBatch}.
     *
     ...
     *
     * The scene will not have a sprite batch. This must be assigned separately
     * with {@link #setSpriteBatch}.
     *
    ...
    bool initWithViewport(const Rect& rect) {
        return initWithViewport(rect.origin.x,rect.origin.y,rect.size.width, rect.size.height);
    }
     ...
     * viewport will match. The scene will not have a sprite batch. This must
     * be assigned separately with {@link #setSpriteBatch}.
     *
    ...
    bool initWithHint(const Size& hint) {
        return initWithHint(hint.width, hint.height);
    }
...
#pragma mark Static Constructors
     ...
     * in the bottom left corner of the display.
     *
     * @return a newly allocated Scene to fill the display.
     */
     ...
     * @param size      The viewport size
     *
     * @return a newly allocated scene with the given viewport.
     */
...
#pragma mark Attributes
     ...
     *
     * This value is analogous to {@link Application#getSafeBounds}, except that
     * it is scaled to match the camera. Note that the position of the camera
...
#pragma mark Resizing
    ...
    void resizeToHint(const Size& hint) {
        resizeToHint(hint.width,hint.height);
    }
...
#pragma mark Scene Rendering
     ...
     * to the scene. If no sprite batch is assigned, nothing is drawn.
     *
