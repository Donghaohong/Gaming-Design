...
private:
    ...
    /** The associated stream for this device */
...
#pragma mark AudioDevices Methods
     ...
     * @return true if initialization was successful
     */
    bool init(SDL_AudioDeviceID device);
     ...
     * @return true if initialization was successful
     */
    bool init(SDL_AudioDeviceID device, Uint8 channels, Uint32 rate,
...
#pragma mark Data Access
    /**
     * Returns the id of the audio device for this output.
     *
     * @return the id of the audio device for this output.
     */
    const SDL_AudioDeviceID id() const  { return _device; }
    
    /**
     * Returns the SDL audio stream in for this output.
     *
     * @return the SDL audio stream in for this output.
     */
    const SDL_AudioStream* getStream() const  { return _stream; }
    
    /**
     * Returns the name of the device associated with this output node.
     *
     * @return the name of the device associated with this output node.
     */
    const std::string getDeviceName() const { return _dvname; }
     ...
     */
    bool isDefault() const { return _device == SDL_AUDIO_DEVICE_DEFAULT_RECORDING; }
...
#pragma mark Audio Graph
     ...
     */
    Uint32 push(Uint8* stream, int len);
...
#pragma mark Optional Methods
     ...
     *
     * This methods creates an internal buffer for recording audio data. This
     * buffer may be returned to at any time with {@link reset()} command.
