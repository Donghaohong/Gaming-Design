 ...
 */
void ObstacleWorld::addObject(const std::shared_ptr<WorldObject>& obj) {
 ...
 * @param obj The object to remove
 */
void ObstacleWorld::removeObject(const std::shared_ptr<WorldObject>& obj) {
