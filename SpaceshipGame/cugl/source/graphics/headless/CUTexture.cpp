...
//
//  This headless version stores texture data (and will even load textures from
//  a file) but does not communicate with a graphics card.
//
//  CUGL MIT License:
 ...
 *
 * Note that subtextures share the image and sampler of their parent. Any
