...
protected:
    ...
    std::shared_ptr<cugl::scene2::WireNode> _wire;
    
    cugl::Poly2 _extrusion;
    
    std::shared_ptr<cugl::scene2::PolygonNode> _solid;
    
    /** The filled star in the center */
    std::shared_ptr<cugl::scene2::PolygonNode> _starNode;
    ...
    cugl::Vec2 _lastMouse;
    
    int _activeTangent = -1;    
