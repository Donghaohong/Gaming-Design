...
#pragma mark Graphics Support
     ...
     *
     * Physics units are the number of pixels per box2d unit. These values
     * are used to create the debug mesh. However, they are also useful for
     * any other object that you wish to attach to this obstacle.
     *
     * @return the physics units for this obstacle.
     */
     ...
     * any other object that you wish to attach to this obstacle.
     *
     * @param units The physics units for this obstacle.
     */
    virtual void setPhysicsUnits(float units);
    
    /**
     * Returns a wireframe mesh representing this obstacle.
     *
     * This mesh can be drawn by a {@link graphics::SpriteBatch} to help with
     * debugging. The wireframe will consist of the physics fixtures adjusted by
     * {@link #getPhysicsUnits}. For proper results, all obstacles should
     * have the same physics units.
     */
