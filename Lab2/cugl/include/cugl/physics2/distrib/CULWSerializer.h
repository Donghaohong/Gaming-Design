...
public:
    ...
    void writeFloat(float f) {
        ...
        std::memcpy(_data.data()+size,bytes,sizeof(float));
    }
    ...
    void writeSint32(Sint32 i) {
        ...
        const std::byte* bytes = reinterpret_cast<const std::byte*>(&ii);
        size_t size = _data.size();
        _data.resize(size+sizeof(Sint32));
        std::memcpy(_data.data()+size,bytes,sizeof(Sint32));
    }
    ...
    void writeUint16(Uint16 i) {
        ...
        const std::byte* bytes = reinterpret_cast<const std::byte*>(&ii);
        size_t size = _data.size();
        _data.resize(size+sizeof(Uint16));
        std::memcpy(_data.data()+size,bytes,sizeof(Uint16));
    }
    ...
    void writeUint32(Uint32 i) {
        ...
        std::memcpy(_data.data()+size,bytes,sizeof(Uint32));
    }
    ...
    void writeUint64(Uint64 i){
        ...
        const std::byte* bytes = reinterpret_cast<const std::byte*>(&ii);
        size_t size = _data.size();
        _data.resize(size+sizeof(Uint64));
        std::memcpy(_data.data()+size,bytes,sizeof(Uint64));
    }
    ...
    void rewriteFirstUint32(Uint32 i) {
        Uint32 ii = marshall(i);
        const std::byte* bytes = reinterpret_cast<const std::byte*>(&ii);
        std::memcpy(_data.data(),bytes,sizeof(Uint32));
    }
