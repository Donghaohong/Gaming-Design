...
//
#ifndef __CU_PHYSICS_SYNCH_EVENT_H__
#define __CU_PHYSICS_SYNCH_EVENT_H__
 ...
 */
class PhysicsSyncEvent : public NetEvent {
public:
    /**
...
public:
     ...
     */
    static std::shared_ptr<PhysicsSyncEvent> alloc() {
        return std::make_shared<PhysicsSyncEvent>();
    }
