 ...
 *
 * This class is an alternative for {@link scene2::SpriteNode} for developers
 * that do not want to use scene graphs in their implementation. Like that
 * class, it allows the user to manage the current frame of the sprite sheet.
 * All drawing details are handled by the class, greatly simplifying the
 * animation.
 *
 * Frames in sprite sheets start in the top right corner and traverse
 * right-to-left one row at a time. It is possible for the final row to be
 * incomplete. With that said, the origin of each frame is still the bottom
 * left corner.
 *
 ...
 * sprite sheet texture.  But as all of these objects may be at different
 * animation frames, they each need their own sprite sheet.
 *
...
#pragma mark Attribute Accessors
     ...
     *
     * The origin is the offset (in pixels) from the bottom left corner of the
     * current frame. The origin is used when drawing the sprite sheet; the
     * transform applies rotations and scale operations relative to this origin.
...
#pragma mark Drawing Commands
     ...
     *
     * Only the active frame will be drawn. The transform will be applied to the
     * active frame at the default origin. The sprite will not be tinted.
     *
     ...
     *
     * Only the active frame will be drawn. The transform will be applied to the
     * active frame at the default origin. The sprite will be tinted by the
     * given color.
     *
     * @param batch     The sprite batch for the drawing
     ...
     *
     * Only the active frame will be drawn. The transform will be applied to the
     * active frame at the specified origin. The sprite will not be tinted.
     *
     * @param batch     The sprite batch for the drawing
     ...
     *
     * Only the active frame will be drawn. The transform will be applied to the
     * active frame at the specified origin. The sprite will be tinted by the
     * given color.
     *
     * @param batch     The sprite batch for the drawing
     * @param color     The tint color
