...
public:
    ...
    std::unordered_map<VertexInfo,Uint32,VertexHasher> vertCache;
    
    /**
     * Creates an unintialized GroupInfo with default values
     */
    GroupInfo() : touched(false), index(0) {
        command = graphics::DrawMode::UNDEFINED;
        object = "";
        material = "";
    }
...
private:
    ...
    /** An index buffer to receive our triangle */
    std::shared_ptr<graphics::IndexBuffer> _indxbuff;
...
#pragma mark Attributes
     ...
     */
    void setIndex(Uint32 value) { _index = value; }
