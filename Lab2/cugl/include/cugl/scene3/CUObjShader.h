...
// We can only support the matrices in the vertex shader (cache these)
// Everything else must move to an internal uniform buffer.
 ...
 */
class ObjShader : public graphics::GraphicsShader {
public:
#pragma mark Constructors
     ...
     */
    static std::shared_ptr<ObjShader> alloc(const graphics::ShaderSource& vsource,
...
#pragma mark Attributes
     ...
     *
     * This method will only succeed if the shader is an active drawing pass.
     *
    ...
    void setNormalMatrix(const Mat4& matrix) {
        pushMat4("uNormalMatrix", matrix);
    }

    /**
     * Sets the light position for this shader.
     *
     * This method will only succeed if the shader is an active drawing pass.
     *
