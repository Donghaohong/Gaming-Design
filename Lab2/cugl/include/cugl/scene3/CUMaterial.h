...
public:
     ...
     */
    TextureInfo() :
    minflt(graphics::TextureFilter::LINEAR),
    magflt(graphics::TextureFilter::LINEAR),
    wrapS(graphics::TextureWrap::REPEAT),
    wrapT(graphics::TextureWrap::REPEAT),
    mipmaps(false) {
...
#pragma mark Attributes
     ...
     */
    int getIllum() const { return _illum; }
...
#pragma mark Usage
     ...
     * draw pass.
     */
    void apply(const std::shared_ptr<ObjShader>& shader);
     ...
     * draw pass.
     */
    static void applyDefaults(const std::shared_ptr<ObjShader>& shader);
