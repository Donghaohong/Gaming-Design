...
#pragma mark Static Constructors
     ...
     * @return true if the sprite is initialized properly, false otherwise.
     */
    static std::shared_ptr<MeshNode> allocWithMesh(const graphics::Mesh<graphics::SpriteVertex>& mesh) {
        std::shared_ptr<MeshNode> node = std::make_shared<MeshNode>();
     ...
     */
    static std::shared_ptr<MeshNode> allocWithPoly(const Poly2& poly,
                                                   const std::vector<Color4> colors) {
        std::shared_ptr<MeshNode> node = std::make_shared<MeshNode>();
     ...
     * @return  true if the sprite is initialized properly, false otherwise.
     */
    static std::shared_ptr<MeshNode> allocWithFile(const std::string filename) {
        std::shared_ptr<MeshNode> node = std::make_shared<MeshNode>();
     ...
     * @return  true if the sprite is initialized properly, false otherwise.
     */
    static std::shared_ptr<MeshNode> allocWithFileMesh(const std::string filename,
                                                       const graphics::Mesh<graphics::SpriteVertex>& mesh) {
        std::shared_ptr<MeshNode> node = std::make_shared<MeshNode>();
     ...
     * @return  true if the sprite is initialized properly, false otherwise.
     */
    static std::shared_ptr<MeshNode> allocWithFilePoly(const std::string filename,
                                                       const Poly2& poly) {
        std::shared_ptr<MeshNode> node = std::make_shared<MeshNode>();
     ...
     * @return  true if the sprite is initialized properly, false otherwise.
     */
    static std::shared_ptr<MeshNode> allocWithTexture(const std::shared_ptr<graphics::Texture>& texture) {
        std::shared_ptr<MeshNode> node = std::make_shared<MeshNode>();
     ...
     * @return  true if the sprite is initialized properly, false otherwise.
     */
    static std::shared_ptr<MeshNode> allocWithTextureMesh(const std::shared_ptr<graphics::Texture>& texture,
                                                          const graphics::Mesh<graphics::SpriteVertex>& mesh) {
        std::shared_ptr<MeshNode> node = std::make_shared<MeshNode>();
     ...
     * @return  true if the sprite is initialized properly, false otherwise.
     */
    static std::shared_ptr<MeshNode> allocWithTexturePoly(const std::shared_ptr<graphics::Texture>& texture,
                                                          const Poly2& poly) {
        std::shared_ptr<MeshNode> node = std::make_shared<MeshNode>();
     ...
     */
    static std::shared_ptr<MeshNode> allocWithData(const AssetManager* manager,
...
#pragma mark Mesh Attributes
    ...
    /**
     * Returns the sprite vertex as the given index
     *
     * This sprite vertex can be updated to change the vertex position,
     * color, texture coordinates, or gradient coordinates.
     *
     * @param index The sprite index
     *
     * @return the sprite vertex as the given index
     */
     ...
     * {@link PolygonNode}.
     *
     * @param poly  The polygon shape
     */
    void setPolygon(const Poly2& poly);

    /**
     * Sets the mesh to match the given rectangle.
     *
     * The mesh textures and colors will be recomputed as if this were a
     * {@link PolygonNode}.
     *
...
#pragma mark Rendering
     ...
     *
     * This method provides the code for drawing a textured mesh in a scene
     * graph. This method only worries about drawing the current node. It does
     * not attempt to render the children. Note that this method is guaranteed
     * to only be called when the node is visible.
     *
