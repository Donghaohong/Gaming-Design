...
private:
    ...
    std::unordered_map<SDL_AudioDeviceID, std::shared_ptr<audio::AudioOutput>> _outputs;
    /** The list of all active input devices */
    std::unordered_map<SDL_AudioDeviceID, std::shared_ptr<audio::AudioInput>>  _inputs;
...
#pragma mark Static Accessors
     ...
     *
     * Once this method is called, all instances of {@link audio::AudioNode}
     * become invalid. In addition, no future instances of {@link audio::AudioNode}
     * may be created. This method should only be called at application shutdown.
     */
    static void stop();
     ...
     */
    static std::unordered_map<std::string, SDL_AudioDeviceID> devices(bool output);
...
#pragma mark Output Devices
     ...
     */
    std::shared_ptr<audio::AudioOutput> openOutput(SDL_AudioDeviceID device);
     ...
     *
     * Once this method is called, the {@link audio::AudioOutput} is invalidated
...
#pragma mark Input Devices
     ...
     */
    std::shared_ptr<audio::AudioInput> openInput(SDL_AudioDeviceID device);
