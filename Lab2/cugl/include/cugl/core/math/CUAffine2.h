 ...
 * to be converted to a 3x3 matrix (for {@link graphics::GraphicsShader} or a
 * 3x4 matrix (for a {@link graphics::UniformBuffer}). For that reason this
 * class contains several static methods for processing float arrays of
 * different strides. These methods interpret stride pairwise. For example, a
 * stride of 4 corresponds to a 3x4 matrix with the first two elements at
 * position 0 and 1, the next two at 4 and 5, and the last two at 8 and 9.
 *
