...
#pragma mark Operators
    /**
     * Increments this time stamp by the given number of nanoseconds
     *
     * SDL3 measures events in terms of nanoseconds. This operator allows
     * us to convert between SDL time and CUGL time using time deltas.
     *
     * @param nanos The number of nanoseconds to increment
     *
     * @return a reference to this time stamp for chaining
     */
    Timestamp& operator+=(Uint64 nanos) {
        _time += std::chrono::nanoseconds(nanos);
        return *this;
    }

    /**
     * Decrements this time stamp by the given number of nanoseconds
     *
     * SDL3 measures events in terms of nanoseconds. This operator allows
     * us to convert between SDL time and CUGL time using time deltas.
     *
     * @param nanos The number of nanoseconds to decrement
     *
     * @return a reference to this time stamp for chaining
     */
    Timestamp& operator-=(Uint64 nanos) {
    ...
    /**
     * Returns a copy of this time stamp incremented by the number of nanoseconds
     *
     * SDL3 measures events in terms of nanoseconds. This operator allows
     * us to convert between SDL time and CUGL time using time deltas.
     *
     * @param nanos The number of nanoseconds to increment
     *
     * @return a copy of this time stamp incremented by the number of nanoseconds
     */
    const Timestamp operator+(Uint64 nanos) const {
        return Timestamp(*this) += nanos;
    }
    
    /**
     * Returns a copy of this time stamp decremented by the number of nanoseconds
     *
     ...
     * @param nanos The number of nanoseconds to decrement
     *
     * @return a copy of this time stamp decremented by the number of nanoseconds
     */
    const Timestamp operator-(Uint64 nanos) const {
        return Timestamp(*this) -= nanos;
    }
