...
#pragma mark Array Reads
     ...
     */
    size_t read(char* buffer, size_t maximum);
     ...
     */
    size_t read(Uint8* buffer, size_t maximum);
     ...
     */
    size_t read(Sint16* buffer, size_t maximum);
     ...
     */
    size_t read(Uint16* buffer, size_t maximum);
     ...
     */
    size_t read(Sint32* buffer, size_t maximum);
     ...
     */
    size_t read(Uint32* buffer, size_t maximum);
     ...
     * @return the number of 32 bit signed integers read from the stream
     */
    size_t read(Sint64* buffer, size_t maximum);
     ...
     * @return the number of 32 bit unsigned integers read from the stream
     */
    size_t read(Uint64* buffer, size_t maximum);
     ...
     */
    size_t read(float* buffer, size_t maximum);
     ...
     */
    size_t read(double* buffer, size_t maximum);
