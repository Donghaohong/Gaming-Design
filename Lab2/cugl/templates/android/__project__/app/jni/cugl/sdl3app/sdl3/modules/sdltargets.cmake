...
function(sdl_cmake_config_required_modules OUTPUT)
  ...
  foreach(collector SDL3-collector SDL3_test-collector)
    ...
    foreach(ID IN LISTS ids)
      ...
      if(CMAKE_MODULE)
        if(EXISTS "${SDL3_SOURCE_DIR}/modules/Find${CMAKE_MODULE}.cmake")
          list(APPEND cmake_modules "${SDL3_SOURCE_DIR}/modules/Find${CMAKE_MODULE}.cmake")
        endif()
      endif()
    endforeach()
    if(cmake_modules)
      list(APPEND cmake_modules "${SDL3_SOURCE_DIR}/modules/PkgConfigHelper.cmake")
    endif()
  endforeach()
...
function(configure_sdl3_pc)
  ...
  configure_file("${SDL3_SOURCE_DIR}/modules/sdl3.pc.in" "${SDL3_BINARY_DIR}/sdl3.pc" @ONLY)
endfunction()
