 ...
 * process them with basic DSP tools. The goal of this library is to provide
 * an alternative to SDL_sound that supports efficient streaming and file
 * output. In addition, it provides a minimal math library akin to (and
 * inspired by) numpy for audio processing. This enables the developer to add
 * custom audio effects that are not possible in SDL_mixer.
 */
