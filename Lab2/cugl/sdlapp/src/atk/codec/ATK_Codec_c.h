 ...
 */
extern SDL_DECLSPEC const char* SDLCALL ATK_CodecNameForType(ATK_CodecType type);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL ATK_WAV_SupportsCommentTag(const char* tag);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL ATK_MP3_SupportsCommentTag(const char* tag);
 ...
 */
extern SDL_DECLSPEC  const char* const * SDLCALL ATK_WAV_GetCommentTags(void);
 ...
 */
extern SDL_DECLSPEC  const char* const * SDLCALL ATK_MP3_GetCommentTags(void);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL ATK_Vorbis_UnloadSource(ATK_AudioSource* source);
 ...
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_Vorbis_SeekSourcePage(ATK_AudioSource* source, Uint32 page);
 ...
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_Vorbis_GetSourcePageSize(ATK_AudioSource* source);
 ...
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_Vorbis_GetSourceFirstPageSize(ATK_AudioSource* source);
 ...
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_Vorbis_GetSourceLastPage(ATK_AudioSource* source);
 ...
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_Vorbis_GetSourceCurrentPage(ATK_AudioSource* source);
 ...
 * @param source    The audio source
 *
 * @return true if the audio source is at the end of the stream; false otherwise
 */
extern SDL_DECLSPEC bool SDLCALL ATK_Vorbis_IsSourceEOF(ATK_AudioSource* source);
 ...
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_Vorbis_ReadSourcePage(ATK_AudioSource* source, float* buffer);
 ...
 * @return the number of audio frames (samples/channels) read
 */
extern SDL_DECLSPEC Sint64 SDLCALL ATK_Vorbis_ReadSource(ATK_AudioSource* source, float* buffer);
 ...
 * @return true if the source was successfully closed.
 */
extern SDL_DECLSPEC bool SDLCALL ATK_FLAC_UnloadSource(ATK_AudioSource* source);
 ...
 * @return the page acquired, or -1 if there is an error
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_FLAC_SeekSourcePage(ATK_AudioSource* source, Uint32 page);
 ...
 * @return the number of audio frames in a page, or -1 if there is an error
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_FLAC_GetSourcePageSize(ATK_AudioSource* source);
 ...
 * @return the number of audio frames on the first page, or -1 if there is an error
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_FLAC_GetSourceFirstPageSize(ATK_AudioSource* source);
 ...
 * @return the index of the last page in the stream, or -1 if there is an error
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_FLAC_GetSourceLastPage(ATK_AudioSource* source);
 ...
 * @return the index of the current page in the stream, or -1 if there is an error
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_FLAC_GetSourceCurrentPage(ATK_AudioSource* source);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL ATK_FLAC_IsSourceEOF(ATK_AudioSource* source);
 ...
 * @return the number of audio frames (samples/channels) read
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_FLAC_ReadSourcePage(ATK_AudioSource* source, float* buffer);
 ...
 * @return the number of audio frames (samples/channels) read
 */
extern SDL_DECLSPEC Sint64 SDLCALL ATK_FLAC_ReadSource(ATK_AudioSource* source, float* buffer);
 ...
 * @return true if the source was successfully closed
 */
extern SDL_DECLSPEC bool SDLCALL ATK_MP3_UnloadSource(ATK_AudioSource* source);
 ...
 * @return the page acquired, or -1 if there is an error
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_MP3_SeekSourcePage(ATK_AudioSource* source, Uint32 page);
 ...
 * @return the number of audio frames in a page, or -1 if there is an error
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_MP3_GetSourcePageSize(ATK_AudioSource* source);
 ...
 * @return the number of audio frames on the first page, or -1 if there is an error
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_MP3_GetSourceFirstPageSize(ATK_AudioSource* source);
 ...
 * @return the index of the last page in the stream, or -1 if there is an error
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_MP3_GetSourceLastPage(ATK_AudioSource* source);
 ...
 * @return the index of the current page in the stream, or -1 if there is an error
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_MP3_GetSourceCurrentPage(ATK_AudioSource* source);
 ...
 * @return true if the audio source is at the end of the stream
 */
extern SDL_DECLSPEC bool SDLCALL ATK_MP3_IsSourceEOF(ATK_AudioSource* source);
 ...
 * @return the number of audio frames (samples/channels) read
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_MP3_ReadSourcePage(ATK_AudioSource* source, float* buffer);
 ...
 * @return the number of audio frames (samples/channels) read
 */
extern SDL_DECLSPEC Sint64 SDLCALL ATK_MP3_ReadSource(ATK_AudioSource* source, float* buffer);
 ...
 * @return true if the source was successfully closed
 */
extern SDL_DECLSPEC bool SDLCALL ATK_WAV_UnloadSource(ATK_AudioSource* source);
 ...
 * @return the page acquired, or -1 if there is an error
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_WAV_SeekSourcePage(ATK_AudioSource* source, Uint32 page);
 ...
 * @return the number of audio frames in a page, or -1 if there is an error
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_WAV_GetSourcePageSize(ATK_AudioSource* source);
 ...
 * @return the number of audio frames on the first page, or -1 if there is an error
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_WAV_GetSourceFirstPageSize(ATK_AudioSource* source);
 ...
 * @return the index of the last page in the stream, or -1 if there is an error
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_WAV_GetSourceLastPage(ATK_AudioSource* source);
 ...
 * @return the index of the current page in the stream, or -1 if there is an error
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_WAV_GetSourceCurrentPage(ATK_AudioSource* source);
 ...
 * @return true if the audio source is at the end of the stream; false otherwise
 */
extern SDL_DECLSPEC bool SDLCALL ATK_WAV_IsSourceEOF(ATK_AudioSource* source);
 ...
 * @return the number of audio frames (samples/channels) read
 */
extern SDL_DECLSPEC Sint32 SDLCALL ATK_WAV_ReadSourcePage(ATK_AudioSource* source, float* buffer);
 ...
 * @return the number of audio frames (samples/channels) read
 */
extern SDL_DECLSPEC Sint64 SDLCALL ATK_WAV_ReadSource(ATK_AudioSource* source, float* buffer);
 ...
 */
extern SDL_DECLSPEC Sint64 SDLCALL ATK_Vorbis_WriteEncoding(ATK_AudioEncoding* encoding,
 ...
 * @param encoding  The encoding stream
 *
 * @return true if the encoding was successfully completed, false otherwise.
 */
extern SDL_DECLSPEC bool SDLCALL ATK_Vorbis_FinishEncoding(ATK_AudioEncoding* encoding);
 ...
 * @return the number of frames written, or -1 on error
 */
extern SDL_DECLSPEC Sint64 SDLCALL ATK_FLAC_WriteEncoding(ATK_AudioEncoding* encoding,
                                                      float* buffer, size_t frames);
 ...
 * @return true if the encoding was successfully completed, false otherwise.
 */
extern SDL_DECLSPEC bool SDLCALL ATK_FLAC_FinishEncoding(ATK_AudioEncoding* encoding);
 ...
 * @return the number of frames written, or -1 on error
 */
extern SDL_DECLSPEC Sint64 SDLCALL ATK_WAV_WriteEncoding(ATK_AudioEncoding* encoding,
                                                     float* buffer, size_t frames);
 ...
 * @return true if the encoding was successfully completed, false otherwise.
 */
extern SDL_DECLSPEC bool SDLCALL ATK_WAV_FinishEncoding(ATK_AudioEncoding* encoding);
