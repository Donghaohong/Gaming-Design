 ...
 */
inline static double tick_naive_sine(Uint64 index, double freq, double offset, bool upper) {
 ...
 */
static double fill_naive_sine(Uint64 index, double freq, double offset, bool upper,
 ...
 */
inline static double tick_naive_triang(Uint64 index, double freq, double offset, bool upper) {
 ...
 * @return the last value generated
 */
static double fill_naive_triang(Uint64 index, double freq, double offset, bool upper,
                                float* buffer, size_t stride, size_t size) {
    double value, t;
    double last = 0;
    float* output = buffer;
 ...
 */
inline static double tick_naive_square(Uint64 index, double freq, double offset, bool upper) {
    double t = SDL_fmod(freq*index+offset/TWO_PI,1);
 ...
 * @return the last value generated
 */
static double fill_naive_square(Uint64 index, double freq, double offset, bool upper,
                                float* buffer, size_t stride, size_t size) {
    double t;
    double last = 0;
    float* output = buffer;
 ...
 */
inline static double tick_naive_tooth(Uint64 index, double freq, double offset, bool upper) {
 ...
 * @return the last value generated
 */
static double fill_naive_tooth(Uint64 index, double freq, double offset, bool upper,
                               float* buffer, size_t stride, size_t size) {
    double value;
    double last = 0;
    float* output = buffer;
 ...
 */
inline static double tick_naive_train(Uint64 index, double freq, double offset, bool upper) {
    double t = SDL_fmod(freq*index+offset/TWO_PI,1);
 ...
 * @return the last value generated
 */
static double fill_naive_train(Uint64 index, double freq, double offset, bool upper,
                               float* buffer, size_t stride, size_t size) {
    double t;
    double last = 0;
    float* output = buffer;
 ...
 */
inline static double tick_poly_square(Uint64 index, double freq, double offset, bool upper) {
    double t = SDL_fmod(freq*index+offset/TWO_PI,1);
    double value = t <= 0.5 ? 1.0 : -1.0;
    value += poly_blep(t,freq);
    value -= poly_blep(SDL_fmod(t + 0.5, 1.0),freq);
 ...
 * @return the last value generated
 */
static double fill_poly_square(Uint64 index, double freq, double offset, bool upper,
                               float* buffer, size_t stride, size_t size) {
    double value, t;
    double last = 0;
    float* output = buffer;
 ...
 */
inline static double tick_poly_tooth(Uint64 index, double freq, double offset, bool upper) {
    double t = SDL_fmod(freq*index+offset/TWO_PI,1);
 ...
 * @return the last value generated
 */
static double fill_poly_tooth(Uint64 index, double freq, double offset, bool upper,
                              float* buffer, size_t stride, size_t size) {
    double value, t;
    double last = 0;
    float* output = buffer;
 ...
 */
inline static double tick_blit_train(Uint64 index, double freq, double offset, bool upper) {
 ...
 * @return the last value generated
 */
static double fill_blit_train(Uint64 index, double freq, double offset, bool upper,
                              float* buffer, size_t stride, size_t size) {
    Uint64 mval = 2*(Uint64)SDL_floor(0.5/freq)+1;
    double step = freq*TWO_PI;
    double phase, denom;
 ...
 */
bool ATK_FillWaveform(ATK_WaveformGen* gen, float* buffer, size_t size) {
 ...
 * @return true if data was successfully generated
 */
bool ATK_FillWaveform_stride(ATK_WaveformGen* gen, float* buffer, size_t stride, size_t size) {
    if (gen == NULL) {
        return false;
    }
