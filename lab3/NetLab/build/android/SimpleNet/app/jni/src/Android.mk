...
LOCAL_SRC_FILES := $(subst $(LOCAL_PATH)/,, \
	$(LOCAL_PATH)/source/NLMenuScene.cpp \
	$(LOCAL_PATH)/source/NLHostScene.cpp \
	$(LOCAL_PATH)/source/NLGameScene.cpp \
	$(LOCAL_PATH)/source/NLClientScene.cpp \
	$(LOCAL_PATH)/source/NLApp.cpp)
