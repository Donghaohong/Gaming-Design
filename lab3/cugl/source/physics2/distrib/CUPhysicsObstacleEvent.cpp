...
//
#include <cugl/physics2/distrib/CUPhysicsObstacleEvent.h>
...
PhysicsObstacleEvent::BoolConsts::BoolConsts() {
    isStatic = false;
    isEnabled = false;
    isAwake = false;
...
/** Creates a new constants group with default values */
PhysicsObstacleEvent::FloatConsts::FloatConsts() {
    density = 0;
    friction = 0;
    restitution = 0;
    linearDamping = 0;
 ...
 */
void PhysicsObstacleEvent::deserialize(const std::vector<std::byte>& data) {
