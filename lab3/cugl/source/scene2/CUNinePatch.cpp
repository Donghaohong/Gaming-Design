...
Uint32 NinePatch::generatePatch(const Rect& src, const Rect& dst, Uint32 offset) {
    ...
    temp.texcoord.y = src.origin.y/tsize.height;
    ...
    temp.texcoord.x = src.origin.x/tsize.width;
    temp.texcoord.y = (src.origin.y+src.size.height)/tsize.height;
    _mesh.vertices.push_back(temp);
 ...
 *
 * This method provides the code for drawing a nine-patch stretched to fill
