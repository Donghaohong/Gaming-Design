...
protected:
    ...
    TextureWrap _wrapt;
    /** Whether this texture has associated mipmaps */
    bool _mipmaps;
...
#pragma mark Properties
     ...
     */
    void setMinFilter(TextureFilter minFilter) { _minfilter = minFilter; }
     ...
     */
    void setMagFilter(TextureFilter magFilter) { _magfilter = magFilter; }
     ...
     */
    void setWrapS(TextureWrap wrap) { _wraps = wrap; }
     ...
     */
    void setWrapT(TextureWrap wrap) { _wrapt = wrap; }
