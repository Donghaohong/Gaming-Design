...
#pragma mark Array Writes
     ...
     */
    void write(const char* array, size_t length);
     ...
     */
    void write(const Uint8* array, size_t length);
     ...
     */
    void write(const Sint16* array, size_t length);
     ...
     */
    void write(const Uint16* array, size_t length);
     ...
     */
    void write(const Sint32* array, size_t length);
     ...
     */
    void write(const Uint32* array, size_t length);
     ...
     */
    void write(const Sint64* array, size_t length);
     ...
     */
    void write(const Uint64* array, size_t length);
     ...
     */
    void write(const float* array, size_t length);
     ...
     */
    void write(const double* array, size_t length);
