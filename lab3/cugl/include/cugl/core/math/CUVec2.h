...
#pragma mark Linear Attributes
     ...
     */
    const Vec3 barycentric(const Vec2& a, const Vec2& b, const Vec2& c);
...
#pragma mark Static Linear Algebra
     ...
     */
    static bool doesSegmentIntersect(const Vec2& A, const Vec2& B,
                                     const Vec2& C, const Vec2& D);
     ...
     */
    static Vec2 getIntersection(const Vec2& A, const Vec2& B,
                                const Vec2& C, const Vec2& D);
