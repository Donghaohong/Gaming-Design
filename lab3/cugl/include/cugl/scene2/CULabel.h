...
protected:
    ...
    /** The blend state for this texture */
    ...
    std::unordered_map<size_t, std::shared_ptr<graphics::GlyphRun>> _glyphrun;
...
#pragma mark Text Coloring
    ...
    /**
     * Sets the color blend mode for this label.
     *
     * By default this value is {@link graphics::BlendMode#PREMULT}, as font
     * atlases are loaded with premultiplied alpha. You cannot determine the
     * blend mode for a node after it is set. You can only get the blend state
     * for that mode with the method {@link #getBlendState}.
     *
     * This blend state only affects the font atlas of the current node. It does
     * not affect any children of the node.
     *
     * @param mode  The color blend mode for this label.
     */
    ...
    /**
     * Sets the color blend state for this label.
     *
     ...
     * {@link graphics::BlendMode#PREMULT}, as font atlases are loaded with
     * premultiplied alpha.
     *
     * This blend state only affects the font atlas of the current node. It does
     * not affect any children of the node.
     *
     * @param blend The color blend state for this label.
     */
    ...
    /**
     * Returns the color blend state for this label.
     *
     ...
     * not affect any children of the node.
     *
     * @return the color blend state for this label.
     */
...
#pragma mark Rendering
     ...
     *
     * This method provides the code for drawing text (from a font atlas) in a
     * scene graph. This method only worries about drawing the current node. It
     * does not attempt to render the children. Note that this method is
     * guaranteed to only be called when the node is visible.
     *
