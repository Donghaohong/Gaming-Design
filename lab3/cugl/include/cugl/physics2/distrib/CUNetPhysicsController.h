...
#pragma mark World Synchronization
     ...
     */
    void processPhysicsObstacleEvent(const std::shared_ptr<PhysicsObstacleEvent>& event);
    
    /**
     * Processes a physics synchronization event.
     */
    void processPhysicsSyncEvent(const std::shared_ptr<PhysicsSyncEvent>& event);
     ...
     */
    void packPhysicsSync(SyncType type);
