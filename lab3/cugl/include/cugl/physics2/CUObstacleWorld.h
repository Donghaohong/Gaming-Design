 ...
 */
class ObstacleWorld : public b2ContactListener,
...
protected:
    ...
    /** The set of selectors in this world */
    std::unordered_set<std::shared_ptr<WorldObject>> _objects;
...
#pragma mark Object Management
    ...
    /**
     * Returns a read-only reference to the set of world objects
     *
     * World objects are non-obstacle, non-joint objects that need to be
     * notified when the world is deleted. The classic example of this is a
     * {@link ObstacleSelector}.
     *
     * @return a read-only reference to the set of world objects
     */
    const std::unordered_set<std::shared_ptr<WorldObject>>& getObjects() const {
        return _objects;
    }
    
    /**
     * Adds the given object to the physics world
     *
     * World objects are non-obstacle, non-joint objects that need to be
     * notified when the world is deleted. The classic example of this is a
     * {@link ObstacleSelector}.
     ...
     */
    virtual void addObject(const std::shared_ptr<WorldObject>& obj);
    
    /**
     * Removes the given object to the physics world
     *
     * World objects are non-obstacle, non-joint objects that need to be
     * notified when the world is deleted. The classic example of this is a
     * {@link ObstacleSelector}.
     ...
     */
    virtual void removeObject(const std::shared_ptr<WorldObject>& obj);
